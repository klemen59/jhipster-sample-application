package fr.eni.spring5.repository;

import fr.eni.spring5.JhipsterSampleApplicationApp;
import fr.eni.spring5.config.Constants;
import fr.eni.spring5.config.audit.AuditEventConverter;
import fr.eni.spring5.domain.PersistentAuditEvent;
...
import static fr.eni.spring5.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
